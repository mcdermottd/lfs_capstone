...
########################
  ...
  # create hs subset
  sub_analysis_set <- subset(analysis_set, flag_analysis_grd == 1)
...
############################################
  ...
  a_acad_by_grd <- analysis_set[, list(n_obs = .N,
  ...
  a_acad <- sub_analysis_set[, list(n_obs = .N,
                                   avg_atten = round(mean(att_rate_wi, na.rm = TRUE), 3),
                                   sd_atten = round(sd(att_rate_wi, na.rm = TRUE), 3),
                                   avg_days_remove = round(mean(days_removed_os, na.rm = TRUE), 3),
                                   sd_remove = round(sd(days_removed_os, na.rm = TRUE), 3),
  ...
  a_acad_by_gender <- sub_analysis_set[, list(n_obs = .N,
                                             avg_atten = round(mean(att_rate_wi, na.rm = TRUE), 3),
                                             sd_atten = round(sd(att_rate_wi, na.rm = TRUE), 3),
                                             avg_days_remove = round(mean(days_removed_os, na.rm = TRUE), 3),
                                             sd_remove = round(sd(days_removed_os, na.rm = TRUE), 3),
  ...
  a_acad_by_region <- sub_analysis_set[, list(n_obs = .N,
                                             avg_atten = round(mean(att_rate_wi, na.rm = TRUE), 3),
                                             sd_atten = round(sd(att_rate_wi, na.rm = TRUE), 3),
                                             avg_days_remove = round(mean(days_removed_os, na.rm = TRUE), 3),
                                             sd_remove = round(sd(days_removed_os, na.rm = TRUE), 3),
...
###################################################
  ...
  a_acad_by_type <- sub_analysis_set[, list(n_obs = .N,
                                           avg_atten = round(mean(att_rate_wi, na.rm = TRUE), 3),
                                           sd_atten = round(sd(att_rate_wi, na.rm = TRUE), 3),
                                           avg_days_remove = round(mean(days_removed_os, na.rm = TRUE), 3),
                                           sd_remove = round(sd(days_removed_os, na.rm = TRUE), 3),
  ...
  a_acad_by_gender_type <- sub_analysis_set[, list(n_obs = .N,
                                                   avg_atten = round(mean(att_rate_wi, na.rm = TRUE), 3),
                                                   sd_atten = round(sd(att_rate_wi, na.rm = TRUE), 3),
                                                   avg_days_remove = round(mean(days_removed_os, na.rm = TRUE), 3),
                                                   sd_remove = round(sd(days_removed_os, na.rm = TRUE), 3),
  ...
  a_wkce_grade_gender_type <- sub_analysis_set[grade == "08" | grade == "10" , list(n_obs = .N,
                                                                                   avg_math_kce = round(mean(zscore_math_kce, na.rm = TRUE), 3),
                                                                                   avg_rdg_kce = round(mean(zscore_rdg_kce, na.rm = TRUE), 3)),
